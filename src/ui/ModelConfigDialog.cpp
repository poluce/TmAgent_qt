...
void show(QWidget* parent, ChatService* chatService)
{
    ...
    page->setYamlPath(chatService->modelConfigPath());
    ...
    const QString yamlPath = chatService->modelConfigPath();
    ...
    QObject::connect(page, &ModelConfigManagerPage::configSaved, dlg, [=](const QVariantMap& config) {
        ...
        chatService->modelFactory()->registerModelConfig(modelConfig);
        ...
        chatService->setDefaultAgentConfig(agentConfig);
