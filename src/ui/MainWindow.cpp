...
{
    const QString agentId = AgentLifecycleSupport::createAgentWithDialog(this, m_chatService);
    if (agentId.isEmpty())
        return;
...
void MainWindow::onDeleteAgentClicked(const QString& agentIdentityId)
{
    ...
    if (trimmedId.isEmpty())
        return;
    if (!AgentLifecycleSupport::deleteAgentWithConfirmation(this, m_chatService, trimmedId))
        return;
...
{
    InformationSettingsDialog::show(this, m_chatService, m_activeIdentityId);
}

void MainWindow::onCommandPolicyClicked()
{
    CommandPolicyDialog::show(this, m_chatService);
}
...
{
    McpConfigDialog::show(this, m_chatService);
}
...
{
    ModelConfigDialog::show(this, m_chatService);
}
