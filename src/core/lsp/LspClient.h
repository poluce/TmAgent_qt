...
public:
    ...
    explicit LspClient(const QString& serverPath, const QStringList& args = {}, QObject* parent = nullptr);
    ~LspClient();
    ...
    // 文档同步
    void notifyDidOpen(const QString& filePath, const QString& text, const QString& languageId = QString());
...
private:
    ...
    void sendLocationRequest(const QString& method, const QString& filePath, int line, int character, LocationCallback callback, const QJsonObject& extraParams = {});
